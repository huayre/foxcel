...
jQuery(document).ready(function(){
    ...
    $("#nuevoOcompa").click(function(){
        url = base_url+"index.php/compras/pedido/nueva_ocompra/"+tipo_oper;
        location.href = url;
    });
    ...
    function on_click_grabar() {
        ...
        if(codigo=='')
            url = base_url+"index.php/compras/pedido/insertar_ocompra";
        else
            url = base_url+"index.php/compras/pedido/modificar_ocompra";
        ...
        $.post(url,dataString,function(data){
            ...
            switch(data.result){
                case 'ok':
                    location.href = base_url+"index.php/compras/pedido/ocompras/0/"+tipo_oper;
                    break;
                case 'error':
                    $("#grabarOcompra").click(on_click_grabar);
                    if(data.campo){
    ...
    $("#limpiarOcompra").click(function(){
        ...
        /*$("#salir").val(1);
        url = base_url+"index.php/compras/pedido/ocompras/0/"+tipo_oper;
        location.href = url;*/
    });

    $("#volverSeguimiento").click(function(){
        $("#salir").val(1);
        url = base_url+"index.php/compras/pedido/seguimiento_ocompras/0/"+tipo_oper+"/1";
        location.href = url;
    });
    ...
    $("#aceptarOcompra").click(function(){
        url = base_url+"index.php/compras/pedido/ocompras/0/"+tipo_oper+"/1";
        location.href = url;
    });
    ...
    $("#imprimirOcompra").click(function(){
        ...
        if (parseInt(inicio) > parseInt(fin)){
            ...
            var url = base_url + "index.php/compras/pedido/ocompra_ver_pdf_rango/"+inicio+"/"+fin;
    ...
    $("#imprimirOcompraFiltro").click(function(){
        ...
        var url = base_url + "index.php/compras/pedido/imprimirOcompraFiltro/" + param;
        window.open(url, '_blank', 'width=700,height=480,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');
    });
    ...
    $("#repo2").click(function(){
        ...
        $("#divRepo4").hide();
        $("#divRepo5").hide();
        url = base_url+"index.php/compras/pedido/estadisticas";
...
function enviar_cotizacion(codigo){
    url = base_url+"index.php/compras/pedido/ventana_cotizacion_correos/"+codigo;
    window.open(url,'',"width=800,height=600,menubars=no,resizable=no;")
}
...
function editar_ocompra(ocompra){
    location.href=base_url+"index.php/compras/pedido/editar_ocompra/"+ocompra+'/'+tipo_oper;
}

function ver_detalle_ocompra(ocompra){
    location.href=base_url+"index.php/compras/pedido/ver_detalle_ocompra/"+ocompra+'/'+tipo_oper;
}

function eliminar_ocompra(ocompra){
    if(confirm('Esta seguro desea eliminar a esta Orden de Compra?')){
        dataString   = "codigo="+ocompra;
        url          = base_url+"index.php/compras/pedido/eliminar_ocompra";
        ;
        $.post(url,dataString,function(data){
            location.href = base_url+"index.php/compras/pedido/ocompras/0/"+tipo_oper;
        });
...
function ver_ocompra(ocompra){
    location.href = base_url+"index.php/compras/pedido/ver_ocompra/"+ocompra;
}

function ocompra_ver_pdf(ocompra){
    //url = base_url+"index.php/compras/pedido/ocompra_ver_pdf/"+ocompra;
    url = base_url+"index.php/compras/pedido/ocompra_ver_pdf_conmenbrete/"+ocompra+"/0";
    window.open(url,'',"width=800,height=600,menubars=no,resizable=no;")
}

function ocompra_ver_pdf_conmenbrete(ocompra){
    url = base_url+"index.php/compras/pedido/ocompra_ver_pdf_conmenbrete/"+ocompra+"/1";
    window.open(url,'',"width=800,height=600,menubars=no,resizable=no;")
}

function ocompra_download_excel(ocompra){
    url = base_url + "index.php/compras/pedido/ocompra_descarga_excel/"+ocompra;
    location.href = url;
}
...
function ver_reporte_pdf(){
    ...
    url = base_url+"index.php/compras/pedido/ver_reporte_pdf/"+fechai+'_'+fechaf+'_'+proveedor+'_'+producto+'_'+aprobado+'_'+ingreso+"/"+tipo_oper;
    window.open(url,'',"width=800,height=600,menubars=no,resizable=no;")
}
...
function obtener_detalle_cotizacion(){//En realidad es detalle de la cotizacion
    ...
    igv        = $("#igv").val();
    url = base_url+"index.php/compras/pedido/obtener_detalle_cotizacion/"+cotizacion;//Es detalle de la cotizacion
...
function ventana_ocompra_factura(ocompra){
    url = base_url+"index.php/compras/pedido/ventana_ocompra_factura/"+ocompra;
    location.href = url;
}
...
function limpiar_campos_producto(){
 ...
 function agregar_todoocompra(guia){
    ...
    descuento100  =  $("#descuento").val();
    igv100        = $("#igv").val();
    url = base_url+"index.php/compras/pedido/obtener_detalle_ocompra2/"+guia;
    n = document.getElementById('tblDetalleOcompra').rows.length;  
    $.getJSON(url,function(data){
        limpiar_datos();
        $.each(data,function(i,item){
...
function agregar_todooventa(guia, serie, numero){
    ...
    var igv100        = $("#igv").val();
    var url = base_url+"index.php/compras/pedido/obtener_detalle_ocompra2/"+guia+"/B";
...
function calcula_cantidad_pendiente(n){
  ...
  //alert("ocodigo"+ocodigo+" "+"producto"+prod+" "+"cantidad "+ cant);
    ...
    url = base_url+"index.php/compras/pedido/calcula_ocantidad_pendiente/"+ocodigo+"/"+prod+"/"+cant;
    $.ajax({
      url: url,
      type: 'POST',
      dataType: 'json',
...
function calcula_cantidad(n){
  ...
  //console.log("cantidad : " + cantidad,"pendiente : " + pendiente, "saliente : " + cantsaliente, "real : "+cantreal);
    ...
    url = base_url+"index.php/compras/pedido/cantidad_oregistrada/"+oventa+"/"+prod+"/"+cant+"/"+pend;
    $.ajax({
      url: url,
      type: 'POST',
      dataType : 'json'
...
function canjeToGuia(OC, pos){
    ...
    $.post(url, { idOC:OC}, function (data) {
        switch (data.result) {
            case 'success':
...
function canjeToComprobante(OC, pos){
    ...
    var url = base_url+"index.php/compras/pedido/insertar_comprobante/"+OC;
