...
jQuery(document).ready(function () {
    ...
    //CAJA PAGO AL GENERAR COMPROBANTE
    $("#continuarPago").click(function () {
            $('#pagado_efectivo').focus();
            importa_total_pagado = $("#importetotal").val();
            $("#importa_total_pagado").html(importa_total_pagado);
            $("#pago_caja").modal("toggle");
    });

    $('#pagado_efectivo').keyup(function(e) {
        if(e.which == 13){
            $("#grabarComprobante").click();
        }
    });
    ...
    $("#grabarComprobante").click(function () {
        ...
        //if ( $("#VerificadoSuccess").val() == "1" ){
            ...
            vuelto = $("#diferencia_vuelto").val();
            pagado = $("#pagado_efectivo").val();
           */
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    Swal.fire({
                        ...
                        title: titulo,
                        html:
                           '<font size="10pt"><b>IMPORTE: </b> ' + importetotal+ 
                           '<br> <b>PAGADO: </b> ' + pagado + 
                            '<br>  <b>VUELTO: </b> ' + vuelto,
                        showConfirmButton: true,
                        width: '500px',
