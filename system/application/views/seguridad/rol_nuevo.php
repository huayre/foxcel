...
<script type="text/javascript" src="<?php echo base_url();?>js/seguridad/rol.js?=<?=JS;?>"></script>
<?php
               ...
               <table>
                ...
                if(count($enlaces)){ ?>
                 ...
                 foreach($enlaces as $enlace){
                  ...
                  $rolU = $this->permiso_model->busca_permiso($rolUsu, $subtext2);
                  $view = ( count($rolU) > 0 ) ? "" : " style='display:none' ";
                  echo $rolU["MENU_Codigo"];
                  if(isset($codigo)){
                    $menu = $menu_base->MENU_Codigo;
                    $ROL_Codigo = $this->permiso_model->busca_permiso($codigo, $subtext2);

                    if(count($ROL_Codigo)>0){
                      echo '<tr '.$view.'><td width="300">&nbsp;&nbsp;&nbsp;<input type="checkbox"   checked="true"  value ="'.$subtext2.'" name="checkO['.$subtext2.']" id="checkO['.$subtext2.']">'.$subtext.'</tr></td>';
                    }
                    else{
                      echo '<tr '.$view.'><td width="300">&nbsp;&nbsp;&nbsp;<input type="checkbox"    value ="'.$subtext2.'" name="checkO['.$subtext2.']" id="checkO['.$subtext2.']">'.$subtext.'</tr></td>';
                    }
                  }else{                        
                    echo '<tr '.$view.'><td width="300">&nbsp;&nbsp;&nbsp;<input type="checkbox"    value ="'.$subtext2.'" name="checkO['.$subtext2.']" id="checkO['.$subtext2.']">'.$subtext.'</tr></td>';
                  }
...
<div style="margin-top:20px; text-align: center">
  <a href="javascript:;" id="grabarRol"><img src="<?php echo base_url();?>images/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton" ></a>
  <a href="javascript:;" id="limpiarRol"><img src="<?php echo base_url();?>images/botonlimpiar.jpg?=<?=IMG;?>" width="69" height="22" class="imgBoton" ></a>
  <a href="javascript:;" id="cancelarRol"><img src="<?php echo base_url();?>images/botoncancelar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a>
  <?php echo $oculto?>
</div>
</form>
</div>
