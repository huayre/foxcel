...
<script type="text/javascript" src="<?php echo base_url();?>js/maestros/tipocambio.js?=<?=JS;?>"></script>
<table class="fuente8" width="93%" border="0" align="center">
  <tr height="90px">
	...
	<tr height="90px">
		<td>&nbsp;</td>
		<td align="center" valign="middle">
			<a href="javascript:history.back();"><img src="<?php echo base_url(); ?>images/botonregresar.png?=<?=IMG;?>" /></a>
		</td>
		<td>&nbsp;</td>
	  </tr>	   
  <!--<tr height="200px">
	<td></td>
	<td><div align="center"><img src="<?php echo base_url();?>images/3.jpg?=<?=IMG;?>" width="496" height="180" /></div></td>
	<td>&nbsp;</td>
  </tr>
  <tr>
	<td>&nbsp;</td>
