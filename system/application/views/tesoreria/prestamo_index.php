...
<script type="text/javascript" src="<?php echo base_url();?>js/tesoreria/prestamo.js?=<?=JS;?>"></script>
<div id="pagina">
        ...
        <div id="frmBusqueda" >
            <?php echo $form_open;?>
                <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                    <tr>
                        <td align='left' width="13%">Nombre Linea</td>
                        <td align='left'><?php echo $nombre_linea;?></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
...
<div class="acciones">
        <div id="botonBusqueda">
            <!-- <ul id="imprimirLinea" class="lista_botones"><li id="imprimir">Imprimir</li></ul>-->
            <ul id="nuevoPrestamo" class="lista_botones"><li id="nuevo">Nuevo Prestamo</li></ul>
            <ul id="limpiarLinea" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
            <ul id="buscarLinea" class="lista_botones"><li id="buscar">Buscar</li></ul> 
        </div>
        <div id="lineaResultado">
            <table class="fuente7" width="100%" cellspacing=0 cellpadding=3 border=0>
                <tr>
                    <td width="50%" align="left">N de prestamos encontradas:&nbsp;<?php echo $registros;?> </td>
                </tr>
            </table>
        </div>
</div>
