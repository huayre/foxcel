    ...
    <form id="form_busqueda" method="post">
        <div class="row fuente8 py-1">
            ...
            <div class="col-sm-2 col-md-2 col-lg-2">
                <input type="text" name="search_descripcion" id="search_descripcion" value="" placeholder="Forma de pago" class="form-control h-1"/>
            </div>
        </div>
    </form>
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                    ...
                    <div class="acciones">
                        <div id="botonBusqueda">
                            <ul class="lista_botones">
                                <li id="nuevo" data-toggle='modal' data-target='#add_fpago'>Forma de pago</li>
                            </ul>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                    <table class="fuente8 display" id="table-fpago">
                        ...
                        <thead>
                            <tr class="cabeceraTabla">
                                ...
                                <td style="width:80%" data-orderable="false">FORMA DE PAGO</td>
...
<div id="add_fpago" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            <form id="formFpago" method="POST">
                ...
                <div style="text-align: center;">
                    <h3><b>REGISTRAR FORMA DE PAGO</b></h3>
                </div>
                <div class="modal-body panel panel-default">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <input type="text" id="descripcion_fpago" name="descripcion_fpago" class="form-control h-2" placeholder="Indique la forma de pago" value="">
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function(){
        $('#table-fpago').DataTable({
            ...
            ajax:{
                    ...
                    data: { dataString: "" },
                    beforeSend: function(){
                        $("#table-fpago .loading-table").show();
                    },
                    error: function(){
                    },
                    complete: function(){
                        $("#table-fpago .loading-table").hide();
                    }
            },
            language: spanish,
