      	...
      	<div class="contenido" style="width: 90%; margin: auto; height: 650px; overflow: auto;">
	      	<div class="tempde_head">
		      	...
		      	<div class="row">
				    ...
				    <div class="col-sm-3 col-md-3 col-lg-3 tempde_stock">
				      	<input type="text" id="tempde_filtro_marca" name="tempde_filtro_marca" list="Marcas" autocomplete="off" placeholder="Marca">
					      	<datalist id="Marcas" name="Marcas"> </datalist>
				    </div>
				    <div class="col-sm-3 col-md-3 col-lg-3 tempde_stock">
				      	<input type="text" id="tempde_filtro_modelo" name="tempde_filtro_modelo" list="modelos" autocomplete="off" placeholder="Modelo">
		      	...
		      	<div class="cajaCabecera">
		      		...
		      		<input type="hidden" class="form-control" name="tempde_flagBs" id="tempde_flagBs" >
		      			<span id="lCompatibles" name="lCompatibles" class="lCompatibles">
                    <img src="<?=base_url();?>images/listagrupal.png" width="24px" name="listaC" id="listaC" style="cursor:pointer;">
                    <span class="txtCompatible">
                        <span class="elistaC">
                            <h4 style="color:#000; font-weight: bold; display: inline-block;">ARTICULOS COMPATIBLES</h4>
                            <img src="<?=base_url();?>images/sprite.png" id="elistaC" name="elistaC" width="12px" style="cursor:pointer;">
                        </span>
                        <p name="txtCompatible" id="txtCompatible"></p>
                    </span>
                </span>

		      		<input type="text" class="form-control" style="display: inline-block; width: 80%;" name="tempde_producto" id="tempde_producto">
		      		<select name="flagBS" id="flagBS" class="form-control" style="display: inline-block; width: 60px;" onchange="limpiar_campos_modal();">
                        <option value="B" selected="selected" title="Producto">P</option>
                        <option value="S" title="Servicio">S</option>
                    </select>
		      		<!-- DETALLES DE VENTAS POR PRODUCTO AL CLIENTE -->
		      			<span style="display: none; height: 45px; width: 20px; cursor: pointer;" id="linkVerVentasArticulo" name="linkVerVentasArticulo">
		      				<img src="<?=base_url();?>images/icono-factura.gif?=<?=IMG;?>"/>
		      			</span>
		      		<!-- END DETALLES DE VENTAS POR PRODUCTO AL CLIENTE -->
		    ...
		    <div class="tempde_body" style="margin-left: 5%;">

		     	<!--LISTA DE ARTICULOS VENDIDOS AL CLIENTE-->
		     	<div class="VentasArticulo" id="VentasArticulo" name="VentasArticulo">
		     	...
		     	<div class="row">
		     		...
		     		<div class="col-sm-3 col-md-3 col-lg-3">Stock General</div>
		     		<div class="col-sm-3 col-md-3 col-lg-3"></div>

		     		<!-- LOTES OCULTOS -->
		     		<div class="col-sm-4 col-md-4 col-lg-4 displayLote" style="display: none">N° de Lote</div>
		     		<div class="col-sm-3 col-md-3 col-lg-3 displayLote" style="display: none">F. Vencimiento</div>
		     	</div>
		     	<div class="row">
		     		<div class="col-sm-3 col-md-3 col-lg-3 tempde_stock"></div>
		     		...
		     		<!-- LOTES OCULTOS -->
		     		<div class="col-sm-4 col-md-4 col-lg-4 displayLote tempde_stock" style="display: none">
		     			<select name="tempde_lote" id="tempde_lote" class="form-control" style="display: inline-block; min-width: 75%; width: auto;" <?=($tipo_docu == 'C') ? 'readonly' : ''; ?> ></select>
		     			<?=($tipo_oper == "C") ? "<img src='".base_url()."images/icono_nuevo.png' style='width:24px; cursor:pointer;' title='Agregar lote' class='addLote'>" : "";?>
		     		</div>
		     		<div class="col-sm-3 col-md-3 col-lg-3 displayLote tempde_stock" style="display: none">
		     			<input type="date" readonly="readonly" name="tempde_vencimientoLote" id="tempde_vencimientoLote" class="cajaSoloLectura">
		     		</div>
		     	</div>
		     	
		     	<!--REGISTRO DE NUEVO LOTE-->
			     	<div class="row rowLote">
			     		<div class="nvoLote">
			     			<div class="col-sm-2 col-md-2 col-lg-2 tempde_stock">
						     	<label for="infoNumeroLote">N° de lote</label>
					     		<input type="text" name="infoNumeroLote" id="infoNumeroLote" value="" placeholder="L-000000">
						    </div>
			     			<div class="col-sm-3 col-md-3 col-lg-3 tempde_stock">
							    <label for="infoVencimientoLote">F. Vencimiento</label>
						     	<input type="date" name="infoVencimientoLote" id="infoVencimientoLote" value="<?=date('Y-m-d');?>">
					      	</div>
			     			<div class="col-sm-4 col-md-4 col-lg-4 tempde_stock">
			     				<br>
			     				<a href="#" class="btn-nvoLote btn btn-success">Nuevo</a>
			     				&nbsp;
			     				<a href="#" class="btn-cancelLote btn btn-danger">Cancelar</a>
					      	</div>
				      	</div>
			     	</div>
		     	<!--FIN DE REGISTRO NUEVO LOTE-->

		     	<br>
		     	<div class="row">
		     		<div class="col-sm-2 col-md-2 col-lg-2"><label for="tempde_cantidad">Cantidad</label></div>
		     		<div class="col-sm-3 col-md-3 col-lg-3"><label for="tempde_precioUnitario">Valor Unit</label></div>
		     		<div class="col-sm-3 col-md-3 col-lg-3"><label for="tempde_subTotal">Sub total</label></div>

		     		<!-- SI ES UNA VENTA, MUESTRA EL IMPUESTO A LA BOLSA PLASTICA -->
		     		<div class="col-sm-1 col-md-1 col-lg-1" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>><label for="tempde_icbper">ICBPER</label></div>
		     	</div>
		     	<div class="row">
		     		<div class="col-sm-2 col-md-2 col-lg-2 tempde_stock">
		     		...
		     		<div class="col-sm-1 col-md-1 col-lg-1 tempde_stock" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>>
		     	...
		     	<div class="row">
		     		<div class="col-sm-3 col-md-3 col-lg-4 tempde_stock">
		     			<select name="tempde_tipoIgv" id="tempde_tipoIgv" onchange="calcular_temProducto_modal()"></select>
		     		</div>
		     		<div class="col-sm-3 col-md-3 col-lg-3 tempde_stock">
...
(function($, window) {
	...
	$(document).ready(function(){
		...
		$("#listaC").click(function(){
                var codP = $("#tempde_codproducto").val();
                $("#txtCompatible").html('');

                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/almacen/producto/productos_compatibles/"+codP,
                    type: "POST",
                    data: {
                        codigo: codP
                    },
                    ...
                    success: function (data) {
                        $(".txtCompatible").show();
                        $("#txtCompatible").html(data);
                    }
                });
            });

            $("#elistaC").click(function(){
                $(".txtCompatible").hide();
                $("#txtCompatible").html('');
            });
		$("#tempde_producto").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    if(!isEncuentra){
	                    ...
	                    //FOXCEL MANEJA COSTOS PROMEDIO - eñ autocomplete jala el costo promedio del producto
