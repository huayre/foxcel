		...
		<div id="pagina">
			<div id="zonaContenido">
                            ...
                            <td colspan="4">
                                <table width="100%" class="fuente8" cellspacing=0 cellpadding=3 border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $cbo_cargo;?></td>
                                        <td>Empresa:</td>
                                        <td><?php echo $cbo_empresa;?></td>
                                        <td>&nbsp</td>
                                        <td>&nbsp</td>
                                    </tr>
                                    <tr>
				...
				<div id="botonBusqueda">
					...
					<a href="#" onclick="atras_directivo();"><img src="<?php echo base_url();?>images/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" border="1" onMouseOver="style.cursor=cursor"></a>
			  </div>
		  </div>
		  </div>
		</div>
