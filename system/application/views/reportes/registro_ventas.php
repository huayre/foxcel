...
<script type="text/javascript">
 ...
 function ejecutarAjax2(){
    ...
    jQuery(document).ready(function() {
        ...
        $("#imprimir_concar").click(function() {
            Swal.fire({
            ...
            location.href = "<?php echo base_url() ?>index.php/reportes/ventas/concar/" + tipo_oper + "/" + tipo_docu + "/" + fecha1 + "/" + fecha2 + "/" + forma_pago + "/" + vendedor + "/" + moneda+"/"+consolidado; 
        });
