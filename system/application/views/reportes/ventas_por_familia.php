...
<script>
  $(document).ready(function(){
    ...
    $("#reporteExcelFamilia").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        alert("Ingrese ambas fechas");
      }
      else{
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/ventas/filtroFamiliaExcel/"+fechaIF;
        }
      }
    });
  });
...
<div id="pagina">
    <div id="zonaContenido">
		<div align="center">
    <div id="tituloForm" class="header">REPORTES DE VENTAS POR FAMILIA</div>
    <div id="frmBusqueda">
      <form method="post" action="" id="generar_reporte">
        ...
        <a href="javascript:;" id="reporteExcelFamilia">
      ...
      if(isset($_POST['reporte'])):
        ...
        $mesFin = $fin[1];
        $anioFin = $fin[0]; ?>
        <br><br><br> Reporte de ventas por familia desde <?php echo $fecha_inicio; ?> hasta el <?php echo $fecha_fin; ?><br/>
  			<table class="fuente8" cellspacing="0" cellpadding="3" border="0" id="Table1">
          <thead>
            <tr class="cabeceraTablaResultado"><th colspan="2">Resumen</th></tr>
            <tr class="cabeceraTabla"><th>Familia</th><th> Ventas S/.</th></tr>
          </thead>
          <tbody> <?php
            $total = 0;
            ...
            foreach($resumen as $fila):
              $total += $fila['VENTAS'];
              echo "<tr><td>{$fila['NOMBRE']}</td><td>".number_format($fila['VENTAS'],2,'.','')."</td>";
            endforeach; ?>
