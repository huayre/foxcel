    ...
    $("#reporteExcelVendedor").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/ventas/filtroVendedorExcel/"+fechaIF;
        }
      }
    });
    ...
    $("#reporteExcelVendedorGeneral").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/ventas/filtroVendedorExcelGeneral/"+fechaIF;
        }
      }
    });
    ...
    $("#reporteExcelVendedorDet").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/ventas/filtroVendedorExcelDet/"+idVendedor+"/"+fechaIF;
        }
      }
    });
    $("#reporteExcelVendedorProds").click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        alert("Ingrese ambas fechas");
      }
      else{
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>index.php/reportes/ventas/excel_producto_por_vendedor/"+idVendedor+"/"+fechaIF;
        }
      }
    });
  });
      ...
      <form method="post" action="" id="generar_reporte">
        ...
        <fieldset>
          ...
          <div class="col-sm-2 col-md-2 col-lg-2 form-group">
            ...
            <input id="fecha_inicio" name="fecha_inicio" type="date" class="form-control w-porc-90 h-1" placeholder="fecha inicial" maxlength="30" value="<?php echo ((isset($_POST['reporte'])) ? $_POST['fecha_inicio'] : ''); ?>">
          </div>
          <div class="col-sm-2 col-md-2 col-lg-2 form-group">
            <label for="fecha_fin">Fecha fin: </label>
            <input id="fecha_fin" name="fecha_fin" type="date" class="form-control w-porc-90 h-1" maxlength="100" placeholder="fecha fin" value="<?php echo ((isset($_POST['reporte'])) ? $_POST['fecha_fin'] : ''); ?>">
          </div>
          

          <div class="col-sm-2 col-md-2 col-lg-2 form-group">
            <label for="fechaf">Vendedor:</label>
            <select id="cboVendedor" name="cboVendedor" class="form-control w-porc-90 h-2">
            <?=$cboVendedor;?>
          </select>
          </div>
          <div class="col-sm-2 col-md-2 col-lg-2 form-group">
            <label for="reporte">REPORTE VENDEDOR:</label>
        ...
        <fieldset>
         ...
         <div class="col-sm-2 col-md-2 col-lg-2 form-group">
          <label for="reporte">REPORTE EXCEL:</label>
         </div>
         <div class="col-sm-2 col-md-2 col-lg-2 form-group">
          <a href="javascript:;" id="reporteExcelVendedorGeneral">
            <img src="<?php echo base_url();?>images/xls.png" style="width:40px; border:none;" class="imgBoton" align="absmiddle"/>Reporte General
          </a>
          </div>
          <div class="col-sm-2 col-md-2 col-lg-2 form-group">
          <a href="javascript:;" id="reporteExcelVendedorProds">
            <img src="<?php echo base_url();?>images/xls.png" style="width:40px; border:none;" class="imgBoton" align="absmiddle"/>Reporte por productos
          </a>
          </div>
        </fieldset> 
        </section>
