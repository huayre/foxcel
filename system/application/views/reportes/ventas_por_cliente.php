    ...
    $('#verReporte').click(function(){
      if($('#fecha_inicio').val() == "" || $('#fecha_fin').val() == ""){
        ...
        if (startDate > endDate){
          ...
          location.href = "<?=base_url();?>" + "index.php/reportes/ventas/resumen_ventas_detallado/"+fechaIF;
        }
      }
    });
...
<div id="pagina">
    ...
    <div id="frmBusqueda">
      ...
      <tr>
      	<td width="8%">  Desde: </td>
      	<td width="40%">
            <input type="text" id="fecha_inicio" name="fecha_inicio" readonly class="cajaMedia fecha" value="<?=$fecha_inicio;?>">
            Hasta: <input type="text" id="fecha_fin" name="fecha_fin" class="cajaMedia fecha" readonly value="<?=$fecha_fin;?>">
        </td>
        <td width="20%">
      ...
      <tr>
          ...
          <input type="text" id="buscar_cliente" class="cajaPequena" name="buscar_cliente" value="<?=$buscar_cliente;?>" placeholder="RUC / DNI" readonly>
