...
<script>
   ...
   dayNamesShort: ['Dom','Lun','Mar','Mié','Juv','Vie','Sdo'],
                    ...
                    <td valign="top">
                        <div class="lienzoreporte" id="divRepo1">
                            ...
                            <table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="3">
                                            ...
                                            <a href="<?php echo base_url();?>index.php/ventas/cliente/ventana_busqueda_cliente/" id="linkVerProveedor"><img height='16' width='16' src='<?php echo base_url(); ?>/images/ver.png?=<?=IMG;?>' title='Buscar' border='0' /></a>
                                    </td>
                                  </tr>
                                  <tr>
                          ...
                          <a href="javascript:;" onclick="ver_reporte_pdf()" id="verReporte">
                            <img  style="margin:15px 0px;" src="<?=base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton">
                          </a>
                        </div>
                                  ...
                                  <tr>
                                    <td colspan="2">
                                      <a href="javascript:;" onclick="ver_reporte_productos()">
                                        <img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton">
                                      </a>
                                    </td>
                                  </tr>
                          </table>
                        ...
                        <div class="lienzoreporte" id="divRepo3">
                              <table>
                               ...
                               <tr><td colspan="6"><hr></td></tr>
                                ...
                                <tr>
                                  <td colspan="2">
                                    <a href="javascript:;" onclick="ver_reporte_pdf_ventas()" ><img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton" ></a>
                                  </td>
                                </tr>
                              </table>
                        </div>
                            <div class="lienzoreporte" id="divRepo4">
                              <table>
                                ...
                                <tr>
                                  <td colspan="2">
                                    <a href="javascript:;" onclick="estadisticas_compras_ventas('V')" ><img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton" ></a>
                                  </td>
                                </tr>
                              </table>
                        </div>
                            <div class="lienzoreporte" id="divRepo5">
                              <table>
                                ...
                                <tr>
                                  <td colspan="1">
                                    <a href="javascript:;" onclick="estadisticas_compras_ventas_mensual('V')" ><img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton" ></a>
                                  </td>
                                  <td colspan="3">
                                    <a href="javascript:;" onclick="estadisticas_compras_ventas_mensual_excel('V')" ><img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/xls.png?=<?=IMG;?>" width="22" height="22" class="imgBoton" ></a>
                                  </td>
                                </tr>
                              </table>
                        </div>
                        <div class="lienzoreporte" id="divRepo7">
                          ...
                          <a href="javascript:;" onclick="ver_reporte_pdf_factura()" id="verReporte"><img  style="margin:15px 0px;"  src="<?php echo base_url();?>images/botonreporte.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton" ></a>
                        </div>
                    </td>
                  </tr>
                </table>
