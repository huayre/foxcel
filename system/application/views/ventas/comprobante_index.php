      					...
      					<div id="frmBusqueda">
      						<table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
                                ...
                                <tr>
                                	...
                                	<td align='left'><input type="text" name="seriei" id="seriei" value="" placeholder="Serie" class="cajaGeneral" size="3" maxlength="3"/>
                                ...
                                <tr>
                                    ...
                                    <!--<a href="<?php echo base_url(); ?>index.php/compras/proveedor/ventana_busqueda_proveedor/"
                                       id="linkVerProveedor"><img height='16' width='16'
                                                              ...
                                                              <td style="text-align: right">
                                                              	<a href="#" id="imprimirRango" name="imprimirRango"><h3>Imprimir Rango</h3></a>
                                                              </td>
                                                            </tr>
                        <!--<tr>
                      	...
                      	<table class="fuente8 display" id="table-comprobante">
                      		...
                      		<thead>
                      			<tr class="cabeceraTabla">
                      				...
                      				<th style="width: 2%" data-orderable="false">&nbsp;</th>
                      				<th style="width: 2%" data-orderable="false">&nbsp;</th>
                      				<th style="width: 7%" data-orderable="false">Vend.</th>
                      			</tr>
                      		</thead>
                      		<tbody></tbody>
                      	</table>
