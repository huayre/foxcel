...
<div id="popup" style="display: none;">
                ...
                <tr>
                    ...
                    <td valign="top" style="border-bottom: rgba(0,0,0,.5) thin solid;">
                        <label for="O" style="cursor: pointer;">
                            <img src="<?=($tipo_oper == 'V') ? base_url().'images/cotizacion.png?='.IMG : base_url().'images/ocompra.png?='.IMG;?>" class="imgBoton"/>
                        </label>
                    ...
                    <td valign="top" style="border-bottom: rgba(0,0,0,.5) thin solid;">
                        <label for="R" style="display: none">
                            <img src="<?php echo base_url() ?>images/docrecurrente.png?=<?=IMG;?>" class="imgBoton"/>
                        </label>
                    ...
                    <td width="80%" rowspan="10" align="left" valign="top">
                        <table width="100%" border="0" align="right" cellpadding="3" cellspacing="0" class="fuente8" style="width: 736px;">
                            ...
                            <tr>
                                <td>Caja:</td>
                                <td colspan="2">
                                    <select name="caja" id="caja" class="form-control w-porc-60 h-2">
    ...
    <br/>
        ...
        <div id="botonBusqueda2" style="padding-top:20px;">
            ...
            <?php if($estado == 2): ?>
           <!--CAJA PARA PAGO-->
            <!--<a href="javascript:;" id="continuarPago"><img src="<?php echo base_url(); ?>images/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a> -->   
...
<!--
<div id="pago_caja" class="modal fade" role="dialog">
    <div class="modal-dialog w-porc-40">
        <div class="modal-content">
            <form id="formCredencial" method="POST">
                <div class="modal-header text-center">
                    <h4 class="modal-title">
                ...
                <div class="modal-body panel panel-default" align="center">
                    <div class="row form-group text-center">
                        <div class="col-sm-11 col-md-11 col-lg-11" style="font-size: 28pt;">
                            <label for="importa_total_pagado">IMPORTE</label>
                            <span id='importa_total_pagado'></span>
                        </div>
                    </div>
                    <br>
                    <div class="row form-group text-center">
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            ...
                            <select name="forma_pago" id="forma_pago" class="form-control h-3" onchange="necesitaCuota()"><?php echo $cboFormaPago; ?></select>
                        </div>
                      
                   
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <label for="forma_pago">CAJA</label>
                            <select name="caja" id="caja" class="form-control h-3">
                            <option value=""> :: SELECCIONE UNA CAJA :: </option> <?php
                            if ($cajas != NULL){
                            foreach ($cajas as $indice => $val){ ?>
                            <option value="<?=$val->CAJA_Codigo;?>" <?=($val->CAJA_Codigo == $caja) ? 'selected' : '';?>><?=$val->CAJA_Nombre;?></option> <?php
                    ...
                    <div class="row form-group text-center">
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <label for="pagado_efectivo">PAGADO</label>
                            <input type="number" id="pagado_efectivo" name="pagado_efectivo" class="form-control h-3" style="font-size: 18pt; font-size-adjust: 100%;" placeholder="PAGADO" value="">
                        </div>
                   
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <label for="diferencia_vuelto">VUELTO</label>
                            <input type="number" id="diferencia_vuelto" name="diferencia_vuelto" class="form-control h-3" style="font-size: 18pt; font-size-adjust: 100%;" placeholder="VUELTO" value="" readonly>
                        </div>
                        <div class="col-sm-1 col-md-1 col-lg-1" id="getUsuario">
                            <span class="icon-loading"></span>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="grabarComprobante" name="grabarComprobante">ENVIAR</button>
...
<script>
    /* PRIMARY */
        $(document).ready(function () {
            $("#pagado_efectivo").keyup(function(event){
                pagado_efectivo = parseFloat($("#pagado_efectivo").val());
                importetotal = parseFloat($("#importetotal").val());
                diferencia_vuelto = pagado_efectivo - importetotal;
                $("#diferencia_vuelto").val(diferencia_vuelto.toFixed(2));
            });
