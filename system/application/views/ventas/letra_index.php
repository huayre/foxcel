<script type="text/javascript" src="<?php echo base_url(); ?>js/ventas/letracambio.js?=<?=JS;?>"></script>
    ...
    <form id="form_busqueda" method="post">
        <div class="row fuente8 py-1">
            <div class="col-sm-3 col-md-3 col-lg-3 form-group">
                <div width="100%"><label for="nombre_cliente"><?=($tipo_oper=='V') ? 'Cliente: ' : 'Proveedor: ';?></label></div>
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 form-group">
               <label for="serie">Serie</label> - <label for="numero">número (letra):</label><br>
                <input type="text" name="seriel" id="seriel" value="" class="cajaMinima" size="130px" maxlength="4"/>
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2 col-lg-2 form-group">
                            <label for="forma_pago">FORMA DE PAGO</label>
                             <select name="forma_pago" id="forma_pago" class="form-control h-3"><?php echo $cboFormaPago; ?></select>
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2 form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="formUpdateLetra" method="POST">
                ...
                <div style="text-align: center;">
                    <h3><b>ACTUALIZAR LETRA</b> <input type="text" id="let_serie" name="let_serie" style="border:0px; width: 100px; align-content: center; "  readonly>-
                        <input type="text" id="let_numero" name="let_numero" style="border:0px; width: 100px; align-content: left;" readonly></h3>
                </div>
                <div class="modal-body panel panel-default">
                    <div class="row">
                        <input type="hidden" id="letraUP" name="letraUP" value="">
                        <input type="hidden" id="cod_comprobante" name="cod_comprobante" value="">
                    ...
                    <div class="row">
                        ...
                        <div class='col-sm-2 col-md-2 col-lg-2'>
                                    <label class='font-8' for=''>CAJA</label>
                                    <select name="caja" id="caja" class="form-control h-3">
                                                            <?php
                                                            if ($caja != NULL){
                                                                foreach ($caja as $indice => $val){ ?>
                                                                    <option value="<?=$val->CAJA_Codigo;?>"><?=$val->CAJA_Nombre;?>
                                                            </option> <?php
                                                                }
                                                            } ?>
                                                        </select>
        ...
        $.ajax({
            ...
            success: function(data){
                if (data.match == true) {
                    ...
                    $("#let_serie").val(info.serie_letra);
                    $("#let_numero").val(info.numero_letra);
                    $("#cod_comprobante").val(info.cod_comprobante);
