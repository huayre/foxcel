        ...
        <div align="center">
            ...
            <div id="cargarBusqueda" >
                ...
                <div id="frmResultado">
                    ...
                    <form id="frmEvaluar" name="frmEvaluar" method="post" action="<?php echo base_url(); ?>index.php/compras/pedido/evaluar_ocompra/">
                        ...
                        <table class="fuente8 display" width="100%" cellspacing="0" cellpadding="3" border="0" id="table-ocompra">
                            <thead>
                                <tr class="cabeceraTabla">
                                    ...
                                    <th style="width:10%" data-orderable="true">RUC/DNI</th>
                                    ...
                                    <th style="width:2.5%" data-orderable="false"></th>
                                    <th style="width:2.5%" data-orderable="false"></th>
                                    <th style="width:10%" data-orderable="false">PEDIDO</th>
                                </tr>
                            </thead>
                            <tbody> 
                            </tbody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 col-md-7 col-lg-7">
                                <textarea id="mensaje" name="mensaje" style="width: 520px; height: 300px">
                                    ...
                                    <p><span class="mail-empresa-envio"></span> ENVÍA UN PRESUPUESTO.</p>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#table-ocompra').DataTable({
            ...
            serverSide: true,
            ajax:{
                    url : "<?=base_url();?>index.php/compras/pedido/datatable_ocompra/<?=$tipo_oper;?>",
                    type: "POST",
                    data: { dataString: "" },
                    beforeSend: function(){
                        $(".loading-table").show();
        ...
        $(".btn-sendMail").click(function(){
            ...
            var url = "<?=base_url();?>index.php/compras/pedido/sendDocMail";
            $.ajax({
                url:url,
                type:"POST",
    ...
    function open_mail( id ){
        ...
        url = "<?=base_url();?>index.php/compras/pedido/getInfoSendMail";
