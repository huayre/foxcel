...
<script type="text/javascript" src="<?php echo base_url(); ?>js/compras/pedido.js?=<?=JS;?>"></script>
                ...
                <tr>
                    ...
                    <td width="30%" valign="middle">
                        ...
                        <select id="tipoComprobante" name="tipoComprobante" class="comboMedio">
                            <?php if($tipo_oper=="V"){ ?>
                            <option value="D" <?=(isset($tipoComprobante) && $tipoComprobante == "D") ? "selected" : "" ?>>COTIZACION</option>
                            <?php }else{ ?>
                            <option value="P" <?=(isset($tipoComprobante) && $tipoComprobante == "P") ? "selected" : "" ?>>ORDEN DE COMPRA</option>
                            <?php }?>
                        </select>
                        <!--<?php if ($tipo_oper == 'V') { ?>
                            <label for="P"><img src="<?php echo base_url() ?>images/presupuesto.png?=<?=IMG;?>" style="cursor:pointer;" class="imgBoton"/></label>
                            <input type="hidden" name="presupuesto" id="presupuesto">
                        <?php } else { ?>
                            <label for="P"><img src="<?php echo base_url() ?>images/cotizacion.png?=<?=IMG;?>" style="cursor:pointer;" class="imgBoton"/></label>
                        <?php } ?>
                        ...
                        <?php if ($tipo_oper == 'V') { ?>
                            <label for="O"><img src="<?php echo base_url() ?>images/docrecurrente.png?=<?=IMG;?>" style="cursor:pointer;" class="imgBoton"/></label>
                        <?php } else { ?>
                            <label for="O"><img src="<?php echo base_url() ?>images/docrecurrente.png?=<?=IMG;?>" style="cursor:pointer;" class="imgBoton"/></label>
                        <?php } ?>
                        ...
                        <table border="0" align="left" cellpadding='3' cellspacing='0' style="font: 8pt helvetica;" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="50%">
                                    ...
                                    <a href="javascript:;" id="linkVerDirecciones"> <img src="<?php echo base_url(); ?>images/ver.png?=<?=IMG;?>" border="0"/> </a>
...
<style type="text/css">
    ...
    <div style="margin:10px 0 10px 0; clear:both">
        ...
        <a href="javascript:;" id="grabarOcompra"><img src="<?php echo base_url(); ?>images/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a>
        <?php endif; ?>
        <a href="javascript:;" id="limpiarOcompra"><img src="<?php echo base_url(); ?>images/botonlimpiar.jpg?=<?=IMG;?>" width="69" height="22" class="imgBoton"></a>
        <a href="javascript:;" id="cancelarOcompra"><img src="<?php echo base_url(); ?>images/botoncancelar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a>
