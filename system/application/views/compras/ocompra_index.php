                ...
                <div class="acciones">
                    <div id="botonBusqueda"> <?php
                        ...
                        <ul id="nuevoOcompa" class="lista_botones">
                            <li id="nuevo">Pedido. de <?=($tipo_oper == 'V') ? 'Venta' : 'Compra';?></li>
                        </ul>
                        ...
                        <table class="fuente8 display" width="100%" cellspacing="0" cellpadding="3" border="0" id="table-ocompra">
                            <thead>
                                <tr class="cabeceraTabla">
                                    ...
                                    <th style="width:2.5%" data-orderable="false"></th>
                                    <th style="width:2.5%" data-orderable="false"></th>
                                    <th style="width:10%" data-orderable="false">CONV. EN GUIA</th>
                                </tr>
                            </thead>
                            <tbody> 
                            </tbody>
