        ...
        <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
            ...
            <!--idex de guiarem-->
                ...
                <td width="18%" style="<?php echo ($tipoGuia==1)?'display:none;':'' ?>">
                    ...
                    <label for="O" style="cursor: pointer"><img src="<?php echo base_url() ?>images/<?php echo $imagenboton?>?=<?=IMG;?>" class="imgBoton"/></label>
            ...
            <tr>
                ...
                <td  style="<?php echo ($tipoGuia==1)?'display:none;':'' ?>" >
                    ...
                    <label for="IMP" style="visibility: hidden; cursor: pointer"><img src="<?php echo base_url() ?>images/importacion.png?=<?=IMG;?>" class="imgBoton"/></label>
            ...
            <tr>
                ...
                <td> <input class="cajaGeneral" name="numero_ref" type="text" id="numero_ref" size="14" maxlength="26" value="<?php echo $numero_ref; ?>"/></td><?php //echo $cboObra; ?> 
    ...
    <div id="frmBusqueda" style="margin-top: 5px">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="">
            <tr>
                ...
                <td valign="top" width="25%" style="display: none;">
