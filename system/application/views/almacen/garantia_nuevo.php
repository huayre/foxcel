...
<script type="text/javascript" src="<?php echo base_url();?>js/almacen/garantia.js?=<?=JS;?>"></script>
...
function JSON_buscarFacturaBoletaXserie(){
  base_url=$("#base_url").val();
  var urls=base_url+"index.php/almacen/garantia/JSON_buscarFacturaBoletaXserie";
  var texto=$("#buscarSerie").val();

  $.ajax({url: urls,
          type:'POST',
          data:"buscarSerie="+texto,
          success: function(result){
            $("#ListarContenidoSeries").html(result);
            alert(result);
    }});
}
...
<form id="frmGarantia" name="frmGarantia" method="post" enctype="multipart/form-data" action="<?php echo $url_action;?>">
    ...
    <div id="zonaContenido">
            <div align="center">
                ...
                <input type="" name="buscarSerie" id="buscarSerie">
                <a href="#" onclick="JSON_buscarFacturaBoletaXserie()">BUSCAR</a>
                ...
                <table border="1">
                  <tr>
                    <td width="10%">ITEM</td>
                    <td colspan="">PRODUCTO</td>
                    <td>CLIENTE</td>
                  </tr>
                 </table>
                 <table  id="ListarContenidoSeries" border="1">
                        ...
                        <div style="width:100%">
                            <table class="fuente8" width="98%" cellspacing="0" cellpadding="6" border="0">
                              ...
                              <tr>
                                ...
                                <a href="<?php echo base_url();?>index.php/ventas/cliente/ventana_busqueda_cliente/" id="linkVerCliente"><img height='16' width='16' src='<?php echo base_url(); ?>/images/ver.png?=<?=IMG;?>' title='Buscar' border='0' /></a></td>
                              </tr>
...
<input type="text" name="nompadre2" id="nompadre2" class="cajaMedia"  style="width:215px;"  value="<?php echo $empresa; ?>" />
                ...
                <div id="divBotones" style="text-align: center; float:left;margin-left: auto;margin-right: auto;width: 98%;margin-top:15px;">
                    <a href="javascript:;" id="imgGuardarGarantia"><img src="<?php echo base_url();?>images/botonaceptar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a>
                    <a href="javascript:;" id="imgLimpiarGarantiaNuevo"><img src="<?php echo base_url();?>images/botonlimpiar.jpg?=<?=IMG;?>" width="69" height="22" class="imgBoton"></a>
                    <a href="javascript:;" id="imgCancelarGarantia"><img src="<?php echo base_url();?>images/botoncancelar.jpg?=<?=IMG;?>" width="85" height="22" class="imgBoton"></a>
