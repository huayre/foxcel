...
<div id="pagina">
    ...
    <form id="form_busquedaGuiasa" name="form_busquedaGuiasa" method="post" action="<?php echo base_url();?>index.php/almacen/guiasa/listar">
<div id="frmBusqueda" >
...
<table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
	...
	<tr>
								...
								Cotización
									...
									<input type="text" id="cotizacion" readonly name="cotizacion" class="cajaGeneral" value="<?php echo $cotizacion; ?>" />
		...
		<tr>
								...
								Pedido
									<div style="margin-left:56px;display:inline;">
										<input type="text" id="pedido" name="pedido" readonly class="cajaGeneral" value="<?php echo $pedido; ?>" />
									</div>
								</div>
  ...
  <div class="acciones">	
    <div id="botonBusqueda">
            <ul id="imprimirGuiasa" class="lista_botones"><li id="imprimir">Imprimir</li></ul>
            <ul id="nuevaGuiasa" class="lista_botones"><li id="nuevo">Nuevo C. de Salida</li></ul>
            <ul id="limpiarGuiasa" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
            <ul id="buscarGuiasa" class="lista_botones"><li id="buscar">Buscar</li></ul> 
    </div>
    <div id="lineaResultado">
        <table class="fuente7" width="100%" cellspacing=0 cellpadding=3 border=0>
        <tr>
            <td width="50%" align="left">N de guias de salida encontrados:&nbsp;<?php echo $registros;?> </td>
        </tr>
        </table>
    </div>
    </div>
