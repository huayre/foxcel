...
<nav class="menu_">
	<ul>
		<li>
			<span class="icon-side-bar"> <img src="<?=base_url();?>images/icon-menu.png" class="icon-p">
				<ul class="menu_opciones"> <?php
					...
					if ( $productos == true){ ?>
						<li class="menu_element">
							<a class="" href="javascript:;" id="stockMin" name="stockMin">
								<img class="imagenMenuDer" alt="" src="<?php echo base_url();?>images/palet-box.png" >
					...
					<section class="menu_element">
						<a class="" href="https://e-consulta.sunat.gob.pe/ol-ti-itconsvalicpe/ConsValiCpe.htm" target="_blank">
							<img class="imagenMenuDer" alt="Contabilidad" src="<?php echo base_url();?>images/sunat.png?=<?=IMG;?>">
					...
					<!--<section class="menu_element">
						<a class="cAMenuD viewCalendar" href="javascript:;">
							<img class="imagenMenuDer" alt="Despacho" src="<?php echo base_url();?>images/calendar-icon.png?=<?=IMG;?>">
		...
		$.ajax({
			...
			success:function (data){
				if(data != null){
					...
					document.getElementById('divStockMin').style.backgroundColor = 'orange';
					var fila = '';
					$("#tableStockMin").html('');
