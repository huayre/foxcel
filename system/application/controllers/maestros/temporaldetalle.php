        ...
        if($keyword!=null && count(trim($keyword))>0){
            ...
            if($datosProducto != null && count($datosProducto) > 0){
                foreach ($datosProducto as $indice => $valor) {
                    ...
                    $pcosto = $valor->PROD_CostoPromedio;
                    $stock = 0;
