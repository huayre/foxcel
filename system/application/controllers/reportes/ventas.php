    ...
    public function concar($tipo_oper = "V", $tipo = "", $fecha1 = "", $fecha2 = "", $forma_pago = "", $vendedor = "", $moneda = "", $consolidado=""){
        ...
        $this->load->library("Excel");
            ...
            /*INICIO CONFIGURACION DE CABECERAS*/
                ...
                $object->setActiveSheetIndex(0)->setCellValue('C2', 'Número de Comprobante');
                $object->setActiveSheetIndex(0)->setCellValue('D2', 'Fecha de Comprobante');
                $object->setActiveSheetIndex(0)->setCellValue('E2', 'Código de Moneda');
                $object->setActiveSheetIndex(0)->setCellValue('F2', 'Glosa Principal');
                $object->setActiveSheetIndex(0)->setCellValue('G2', 'Tipo de Cambio');
                $object->setActiveSheetIndex(0)->setCellValue('H2', 'Tipo de Conversión');
                $object->setActiveSheetIndex(0)->setCellValue('I2', 'Flag de Conversión de Moneda');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('L2', 'Código de Anexo');
                $object->setActiveSheetIndex(0)->setCellValue('M2', 'Código de Centro de Costo');
                $object->setActiveSheetIndex(0)->setCellValue('N2', 'Debe / Haber');
                $object->setActiveSheetIndex(0)->setCellValue('O2', 'Importe Original');
                $object->setActiveSheetIndex(0)->setCellValue('P2', 'Importe en Dólares');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('S2', 'Número de Documento');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('V2', 'Código de Area');
                $object->setActiveSheetIndex(0)->setCellValue('W2', 'Glosa Detalle');
                $object->setActiveSheetIndex(0)->setCellValue('X2', 'Código de Anexo Auxiliar');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('AA2', 'Número de Documento Referencia');
                $object->setActiveSheetIndex(0)->setCellValue('AB2', 'Fecha Documento Referencia');
                $object->setActiveSheetIndex(0)->setCellValue('AC2', 'Nro Máq. Registradora Tipo Doc. Ref.');
                $object->setActiveSheetIndex(0)->setCellValue('AD2', 'Base Imponible Documento Referencia');
                $object->setActiveSheetIndex(0)->setCellValue('AE2', 'IGV Documento Provisión');
                $object->setActiveSheetIndex(0)->setCellValue('AF2', 'Tipo Referencia en estado MQ');
                $object->setActiveSheetIndex(0)->setCellValue('AG2', 'Número Serie Caja Registradora');
                $object->setActiveSheetIndex(0)->setCellValue('AH2', 'Fecha de Operación');
                $object->setActiveSheetIndex(0)->setCellValue('AI2', 'Tipo de Tasa');
                $object->setActiveSheetIndex(0)->setCellValue('AJ2', 'Tasa Detracción/Percepción');
                $object->setActiveSheetIndex(0)->setCellValue('AK2', 'Importe Base Detracción/Percepción Dólares');
                $object->setActiveSheetIndex(0)->setCellValue('AL2', 'Importe Base Detracción/Percepción Soles');
                $object->setActiveSheetIndex(0)->setCellValue('AM2', 'Tipo Cambio para \'F\'');
                $object->setActiveSheetIndex(0)->setCellValue('AN2', 'Importe de IGV sin derecho crédito fiscal');
            
            
                $object->setActiveSheetIndex(0)->setCellValue('A3', 'Restricciones');
                $object->setActiveSheetIndex(0)->setCellValue('B3', 'Ver T.G. 02');
                $object->setActiveSheetIndex(0)->setCellValue('C3', 'Los dos primeros dígitos son el mes y los otros 4 siguientes un correlativo');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('G3', 'Llenar  solo si Tipo de Conversión es "C". Debe estar entre >=0 y <=9999.999999');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('J3', 'Si Tipo de Conversión "F"');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('N3', '"D" ó "H"');
                $object->setActiveSheetIndex(0)->setCellValue('O3', 'Importe original de la cuenta contable.Si Flag de Conversión de Moneda esta en ´S´, debe estar entre >=0 y <=99999999999.99');
                $object->setActiveSheetIndex(0)->setCellValue('P3', 'Importe de la Cuenta Contable en Dólares. Obligatorio si Flag de Conversión de Moneda esta en "N", debe estar entre >=0 y <=99999999999.99 ');
                $object->setActiveSheetIndex(0)->setCellValue('Q3', 'Importe de la Cuenta Contable en Soles. Obligatorio si Flag de Conversión de Moneda esta en "N", debe estra entre >=0 y <=99999999999.99 ');
                $object->setActiveSheetIndex(0)->setCellValue('R3', 'Si Cuenta Contable tiene habilitado le Documento Referencia Ver. T.G. 06');
                $object->setActiveSheetIndex(0)->setCellValue('S3', 'Si Cuenta Contable tiene habilitado el Documento Referencia Incluye Serie y Número');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('Z3', 'Si Tipo de Documento es "NA" ó "ND" Ver T.G. 06');
                
                $object->setActiveSheetIndex(0)->setCellValue('AA3', 'Si Tipo de Documento es "NC", "NA" ó "ND", incluye Serie y Número');
                $object->setActiveSheetIndex(0)->setCellValue('AB3', 'Si tipo de Documento es "NC", "NA" ó "ND"');
                $object->setActiveSheetIndex(0)->setCellValue('AC3', 'Si tipo de Documento es "NC", "NA" ó "ND". Solo cuando el Tipo Documento de Referencia "TK"');
                $object->setActiveSheetIndex(0)->setCellValue('AD3', 'Si tipo de Documento es "NC", "NA" ó "ND"');
                $object->setActiveSheetIndex(0)->setCellValue('AE3', 'Si tipo de Documento es "NC", "NA" ó "ND"');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('AM3', 'Especificar solo si Tipo Conversión es "F". Se permite "M" Compra y "V" Venta.');
                $object->setActiveSheetIndex(0)->setCellValue('AN3', 'Especificar solo para comprobantes de compras con IGV sin derecho de crédito Fiscal. Se detalle solo en la cuenta 42xxxx');
                

                $object->setActiveSheetIndex(0)->setCellValue('A4', 'Tamaño/Formato');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('G4', 'Numérico 11, 6');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('N4', '1 Carácter');
                $object->setActiveSheetIndex(0)->setCellValue('O4', 'Numérico 14,2');
                $object->setActiveSheetIndex(0)->setCellValue('P4', 'Numérico 14,2');
                $object->setActiveSheetIndex(0)->setCellValue('Q4', 'Numérico 14,2');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('AD4', 'Númerico 14, 2');
                $object->setActiveSheetIndex(0)->setCellValue('AE4', 'Númerico 14, 2');
                ...
                $object->setActiveSheetIndex(0)->setCellValue('AJ4', 'Númerico 14, 2');
                $object->setActiveSheetIndex(0)->setCellValue('AK4', 'Númerico 14, 2');
                $object->setActiveSheetIndex(0)->setCellValue('AL4', 'Númerico 14, 2');
                $object->setActiveSheetIndex(0)->setCellValue('AM4', '1 Caracter');
                $object->setActiveSheetIndex(0)->setCellValue('AN4', 'Númerico 14, 2');
