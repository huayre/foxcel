...
##########################################################################
    ...
    public function __construct(){
        ...
        $this->ci->load->model('ventas/importacion_model');
        $this->ci->load->model('ventas/importaciondetalle_model');
    ...
    public function ObtenerSeriesComprobante($comprobante, $tipoComprobante, $producto, $return = "concat", $nota = NULL){
         ...
         ********** ID PARA TIPOS DE DOCUMENTOS
            ...
            12 - NOTA DE DEBITO
            13 - PRESUPUESTO
            14 - COMPROBANTE GENERAL
            15 - GUIA DE TRANSFERENCIA
            16 - LETRA DE CAMBIO
         ******************************************************
        ******************************************************/
        ...
        if ($nota != NULL) // Si estoy buscando series de una nota de credito, busca por el id del comprobante donde el movimiento sea ingreso -> 1
    ...
    public function sendMail($menu = NULL, $codigo = NULL, $titulo = NULL, $msg = NULL, $pdf = NULL) {
        ...
        $titulo = ($titulo == NULL) ? "NOTIFICACIÓN DE DESPACHO." : $titulo;
    ...
    public function sendDocMail($titulo = NULL, $destinatario, $mensaje = NULL, $adjunto = true, $tipo = NULL, $codigo = NULL, $docs = NULL) {
        ...
        if ($adjunto == true){
            ...
            if ($tipo == 13 || $tipo == 21){
                $doc = $this->pedido_pdf($codigo, 1, true);
                $mail->AddStringAttachment($doc, "PRESUPUESTO_".date('d-m-Y').".pdf");
            }
...
#########################################################################
    ...
    ########################
        public function ocompra_pdf($codigo, $flagPdf = 1, $enviarcorreo = false){
            ...
            $empresaInfo =  $this->ci->empresa_model->obtener_datosEmpresa( $establecimientoInfo[0]->EMPRP_Codigo );
            if($tipo_oper=="V"){
                $tipoDocumento = "PEDIDO <br>DE VENTA";
                $tipoDocumentoF = "PEDIDO DE VENTA";
            }else{
        ...
        public function ocompra_rango_group($inicio = 1, $fin = 20, $oper = "V", $flagPdf = 1, $enviarcorreo = false){
            ...
            $this->pdf->SetMargins(7, 15, 10); // Cada 10 es 1cm - Como es hoja estoy tratando las medidad en cm -> Rawil
            ...
            foreach ($lista_ocompra as $key => $val) {
                ...
                $nFecha = explode( '/', mysql_to_human($arrfecha[0]) );
                $fecha = $nFecha[0]." de ".ucfirst( strtolower($this->mesesEs($nFecha[1])) )." del ".$nFecha[2]; // strlower -> todo a minuscula, ucfirst primer caracter a mayuscula
                $flagIngreso = $datos_ocompra[0]->OCOMC_FlagIngreso;
    ...
    ########################
                ...
                if ($infoBancos != NULL){
                    $infoBancosHTML .= '<tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:14.5cm; font-weight:normal;">'.$infoBancos[0]->CUENT_Titular.'</td>
                                        </tr>';
                    foreach ($infoBancos as $indice => $val) {
                        /*$infoBancosHTML .= '<tr>
                                                <td style="width:1.0cm; font-weight:bold;">BANCO:</td>
                                                <td style="width:1.5cm; font-weight:normal;">'.$val->BANC_Siglas.'</td>
                                                <td style="width:2.0cm; font-weight:bold;">N° CUENTA:</td>
                                                <td style="width:4.0cm; font-weight:normal;">'.$val->CUENT_NumeroEmpresa.'</td>
                                                <td style="width:1.5cm; font-weight:bold;">TITULAR:</td>
                                                <td style="width:6.0cm; font-weight:normal;">'.$val->CUENT_Titular.'</td>
                                            </tr>
                                        ';*/
        ...
        public function comprobanteImportacion_pdf_a4($codigo, $flagPdf = 1, $enviarcorreo = false){
            $datos_comprobante = $this->ci->importacion_model->obtener_comprobante($codigo);


            $detalle_comprobante = $this->ci->importaciondetalle_model->detalles($codigo);
            ...
            foreach ($detalle_comprobante as $indice => $valor) {
                ...
                $detaProductos = $detaProductos. '
                    <tr bgcolor="'.$bgcolor.'">
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:center;">'.(float)$valor->IMPORDEP_CantidadProducto.'</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:left;">'.$valor->PROD_CodigoUsuario.'</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:left;">'.$nombre_producto.'</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:center;">'.$valor->MARCC_Descripcion.'</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:right;">'.number_format($valor->IMPORDEP_PrecioCompra, 2).'</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:right;">'.number_format($valor->IMPORDEP_PrecioVenta, 2).'</td>
            ...
            $clienteHTML = '<table style="text-indent:0cm;" cellpadding="0.02cm" border="0">
                        <tr>
                            <td style="width:3.2cm"><b>PROVEEDOR</b></td>
                            <td colspan="2" style="width:9.8cm; text-indent:-0.1cm;">'.$nombre_proveedor.'</td>

                            <td style="width:2.6cm; font-weight:bold;">COMI. BROKER:</td>
                            <td>'.(float)$datos_comprobante[0]->IMPOR_ComisionBroker.'%</td>
                        </tr>
                        <tr>
                            <td style="width:3.2cm; font-weight:bold;">RUC:</td>
                            <td style="width:9.2cm; text-indent:-0.1cm;">'.$ruc.'</td>
                            ...
                            <td style="width:0.6cm;"></td>
                            <td style="width:2.6cm; font-weight:bold;">GASTON CHINA:</td>
                            <td>$ '.(float)$datos_comprobante[0]->IMPOR_GastosChina.'</td>
                        </tr>
                        <tr>
                            <td style="width:3.2cm; font-weight:bold;">DENOMINACIÓN:</td>
                            <td style="width:9.2cm; text-indent:-0.1cm; text-align:justification">'.$nombre_cliente.'</td>
                            ...
                            <td style="width:0.6cm;"></td>
                            <td style="width:2.6cm; font-weight:bold;">FLETE INTERN.:</td>
                            <td>$ '.(float)$datos_comprobante[0]->IMPOR_FleteInternacional.'</td>
                        </tr>
                        <tr>
                            <td rowspan="2" style="width:3.2cm; font-weight:bold;">DIRECCIÓN:</td>
                            <td rowspan="2" style="width:9.2cm; text-indent:-0.1cm; text-align:justification">'.$direccion.'</td>
                            ...
                            <td style="width:0.6cm;"></td>
                            <td style="width:2.6cm; font-weight:bold;">SEGURO INTERN.:</td>
                            <td>$ '.(float)$datos_comprobante[0]->IMPOR_SeguroInternacional.'</td>
                        </tr>
                        <tr> 
                            <td style="width:0.6cm;"></td>
                            <td style="width:2.6cm; font-weight:bold;">PERCEPCIÓN:</td>
                            <td>$ '.(float)$datos_comprobante[0]->IMPOR_PercepcionDolares.'</td>
                        </tr>
                        <tr>
                            <td style="width:4.5cm"><b>FLETE CALLAO AL ALMACEN</b></td>
                            <td  style="width:2.1cm">$ '.(float)$datos_comprobante[0]->IMPOR_FleteCallaoAlmacen.'</td>

                            <td style="width:4.2cm;font-weight: bold">GASTOS DE DESCARGA</td>
                            <td style="width:2.1cm">$'.(float)$datos_comprobante[0]->IMPOR_GastosDescarga.'</td>
                            <td style="width:4.2cm;font-weight: bold">G. FACILIDADES ADUANAS</td>
                            <td style="width:2.1cm">$ '.(float)$datos_comprobante[0]->IMPOR_GastosFacilidadAduanas.'</td>
                        </tr>
                         
                        <tr>
                            <td style="width:6.2cm"><b>GASTOS QUE COBRA ADUANAS</b></td>
                            <td  style="width:2.8cm; text-indent:-0.1cm;">$ '.(float)$datos_comprobante[0]->IMPOR_GastoQCobraAduanas.'</td>
                            <td style="width:2.6cm; font-weight:bold;">UTILIDAD</td>
                            <td>'.(float)$datos_comprobante[0]->IMPOR_PorcentajeUtilidad.'%</td>
                        </tr>
            ...
            $this->pdf->settingHeaderData($empresaInfo[0]->EMPRC_Ruc,'IMPORTACION' , $datos_comprobante[0]->IMPOR_Serie,$this->getOrderNumeroSerie($datos_comprobante[0]->IMPOR_Numero));
            $this->pdf->AddPage();
            $this->pdf->RoundedRect(10, 53, 190, 33, 1.50, '1111', '');
            $this->pdf->writeHTML($clienteHTML,true,false,true,'');
            ...
            $productoHTML = '
                    <table border="0" style="font-size: 8pt; line-height:5mm;">
                        <tr style="font-size: 8pt">
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2cm;">CANT.</th>
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2cm;">CÓDIGO</th>
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:8.3cm;">DESCRIPCIÓN</th>
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2.4cm;">MARCA</th>
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2cm;">P/Costo</th>
                            <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2cm;">P/Venta</th>
                        </tr>
                        '.$detaProductos.'
                    </table>';
            $this->pdf->writeHTML($productoHTML,true,false,true,'');
            ...
            $totalesHTML = '<table align="right" cellspacing="0.1cm">
                        ...
                        <tr>
                            <td style="width:15cm; font-weight:bold;">Percepción Total en Soles :</td>
                            <td style="width:01.0cm; font-weight:bold;">S/</td>                            
                            <td style="width:02.0cm; font-weight:bold;">'.number_format($datos_comprobante[0]->IMPOR_PercepcionSoles,2).'</td>
                        </tr>
                    </table>';
            $this->pdf->writeHTML($totalesHTML,true,false,true,'');
        ...
        public function carta_de_garantia($codigo, $flagPdf = 1, $enviarcorreo = false){   
            ...
            $this->pdf->SetMargins(20, 50, 20); // Cada 10 es 1cm - Como es hoja estoy tratando las medidad en cm -> Rawil
            ...
            $referenciasHTML = '<table border="0" cellspacing="1mm">
                                <tr>
                                    <td style="width:3.0cm; font-weight:bold;">O.C. (CLIENTE):</td>
    ...
    ########################
        ...
        public function cuentas_pdf($data, $flagPdf = 1, $enviarcorreo = false){
            ...
            foreach ($cuentas as $i => $val){
                ...
                $avance =  ($listado_pagos == NULL) ? 0 : $this->ci->pago_model->sumar_pagos($listado_pagos, $val->MONED_Codigo);
            ...
            if ($pagos != NULL){
                foreach ($pagos as $indice => $val){
                    ...
                    $cuentasDetaHTML .= '<tr '.$background.' style="font-size: 8pt">
                                            <td style="'.$style->border_top.' font-weight:bold; text-align:left; width:1.5cm;">FECHA:</td>
                                            <td style="'.$style->border_top.' text-align:center; width:2.0cm;">'.$fecha.'</td>

                                            <td style="'.$style->border_top.' font-weight:bold; text-align:center; width:1.5cm;">PAGO:</td>
                                            <td style="'.$style->border_top.' text-align:center; width:1.5cm;">'.$serieNumero.'</td>
                                            ...
                                            <td style="'.$style->border_top.' font-weight:bold; text-align:center; width:2.0cm;">MONEDA:</td>
                    ...
                    if ($val->PAGC_FormaPago != 1){
                        ...
                        if ($val->CHEP_Codigo != ""){
                            ...
                            $cuentasDetaHTML .= '<tr '.$background.'>
                                                    ...
                                                    <td style="'.$style->border_bottom.'text-align:left; width:3.0cm;">'.$val->PAGC_Trans.'</td>
                                                    <td style="'.$style->border_bottom.'font-weight:bold; text-align:left; width:3.0cm;">DEPOSITO</td>
                                                    <td style="'.$style->border_bottom.'text-align:left; width:10.0cm;">'.$val->PAGC_DepoNro.'</td>
                                                </tr>';
                        }
                    }
    ...
    ########################
        ...
        public function movimientos_pdf($caja, $fechai, $fechaf, $enviarcorreo = false){
            ...
            $tituloHTML = '<p style="width: 8.0cm; font-weight:bold">USUARIO: '.$this->nombre_persona.'</p><table border="0" style="font-size: 8pt; line-height:5mm;">
                                <tr>
    ...
    ########################
        ...
        public function guiatrans_pdf($codigo, $flagPdf = 0, $enviarcorreo = false){
            ...
            $medidas = "a4"; // a4 - carta
            $this->pdf = new pdfGeneral('P', 'mm', $medidas, true, 'UTF-8', false);
            $this->pdf->SetMargins(7, 55, 10); // Cada 10 es 1cm - Como es hoja estoy tratando las medidad en cm -> Rawil
    ...
    public function guiarem_pdf($codigo, $flagPdf = 0, $enviarcorreo = false){
        ...
        $productoHTML = '<table cellpadding="0.1cm" style="font-size:8pt;">
                    <tr bgcolor="#ce7974" style="font-size:8pt;">
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:10%;"> CANTIDAD</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:10%;"> CÓDIGO</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:10%;"> UND.</td>
                        <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:left; width:50%;">DESCRIPCIÓN</td>
                        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:20%;">MARCA</th>
                    </tr>
                    '.$detaProductos.'
                </table>';
        $this->pdf->writeHTML($productoHTML,true,false,true,'');
...
#########################################################################
    ...
    public function ocompra_descarga_excel($codigo){
        ...
        $arrfecha = explode(" ", $datos_ocompra[0]->OCOMC_FechaRegistro);
        $nFecha = explode('/', mysql_to_human($arrfecha[0]) );
        $fecha = $nFecha[0]." de ".ucfirst( strtolower($this->mesesEs($nFecha[1])) )." del ".$nFecha[2]." a las ".$this->formatHours($arrfecha[1]); // strlower -> todo a minuscula, ucfirst primer caracter a mayuscula
        $flagIngreso = $datos_ocompra[0]->OCOMC_FlagIngreso;
