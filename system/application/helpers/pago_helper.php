...
function obtener_estado_de_cuenta($saldo, $avance, $fecha, $fechaVencimiento, $viewLeyanda = true){
    ...
    if ($saldo <= 0)
        $result = "<button type='button' class='btn btn-default font-8 color-black estadoC' title='Cancelado'>Cancelado</button>";
    else
        $result = "<button type='button' class='btn font-8 color-black estadoC' style='background-color:$color' title='Pendiente con Avance'>Pend. (AV)</button>";
        
    if ($avance == 0)
        $result = "<button type='button' class='btn font-8 color-black estadoC' style='background-color:$color' title='Pendiente'>Pendiente</button>";
