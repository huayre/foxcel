...
define('TITULO',                                'SISTEMA ERP FOXCEL');
...
define('CSS', 'v-1.0.0.2');
define('JS', 'v-1.0.0.2');
define('IMG', 'v-1.0.0.2');

// TAMAÑO LIMITE DE DETALLES EN LOS DOCUMENTOS
define('VENTAS_GUIA', 25);
define('COMPRAS_GUIA', 25);
define('VENTAS_FACTURA', 25);
define('VENTAS_BOLETA', 25);
define('VENTAS_COMPROBANTE', 25);

define('COMPRAS_FACTURA', 25);
define('COMPRAS_BOLETA', 25);
