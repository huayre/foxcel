 ...
 * The $active_group variable lets you choose which connection group to| make active.  
...
$db['default']['password'] = "";
$db['default']['database'] = "sistemadefactura_foxcel";

#$db['default']['username'] = "sistemadefactura_foxcel";
#$db['default']['password'] = "sistemadefactura_foxcel";
#$db['default']['database'] = "sistemadefactura_foxcel";
